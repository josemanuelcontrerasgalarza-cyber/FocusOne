...
-- El usuario puede actualizar su propio nombre/email/avatar, pero SOLO esas
-- columnas: streak_current/streak_best/streak_last_date quedan fuera del
-- grant para que nadie pueda falsificar su racha escribiendo directo a
-- profiles (esos campos los escribe únicamente el trigger de la racha).
